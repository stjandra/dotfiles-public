...
(after! mu4e
  ...
  (set-email-account! "gmail"
                      '(
                        (user-mail-address      . "firstname_lastname@gmail.com")
                        (user-full-name         . "Firstname Lastname")
                        (mu4e-get-mail-command  . "mbsync firstname_lastname@gmail.com")
                        (smtpmail-smtp-server   . "smtp.gmail.com")
                        (smtpmail-smtp-service  . 465)
                        (smtpmail-stream-type   . ssl)
                        (smtpmail-smtp-user     . "firstname_lastname@gmail.com")
                        ;;(mu4e-compose-signature . "---\nFirstname Lastname")
                        ;;(mu4e-compose-signature . (get-string-from-file "~/signature.txt"))
                        (mu4e-sent-folder       . "/firstname_lastname@gmail.com/[Gmail]/Sent Mail")
                        (mu4e-trash-folder      . "/firstname_lastname@gmail.com/[Gmail]/Trash")
                        (mu4e-drafts-folder     . "/firstname_lastname@gmail.com/[Gmail]/Drafts")
                        (mu4e-refile-folder     . "/firstname_lastname@gmail.com/[Gmail]/All Mail")
                        (mu4e-maildir-shortcuts
                         ("/firstname_lastname@gmail.com/INBOX" . ?i)
                         ("/firstname_lastname@gmail.com/[Gmail]/Sent Mail" . ?s)
                         ("/firstname_lastname@gmail.com/[Gmail]/Trash" . ?t)
                         ("/firstname_lastname@gmail.com/[Gmail]/Drafts" . ?d)
                         ("/firstname_lastname@gmail.com/[Gmail]/All Mail" . ?a)
                         )
                        )
                      nil)
